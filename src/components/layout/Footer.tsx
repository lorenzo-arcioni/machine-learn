      ...
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="hover:text-primary" onClick={handleHomeClick}>Home</Link></li>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            {/* Facebook */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="Facebook">
            ...
            {/* WhatsApp */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Kaggle */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="Kaggle">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Medium */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="Medium">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* LinkedIn */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* GitHub */}
            <a href="#" className="text-muted-foreground hover:text-primary" title="GitHub">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
